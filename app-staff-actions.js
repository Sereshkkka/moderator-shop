        ...
        '<div class="modal-overlay" id="bm_overlay">',
            '<div class="modal-content" style="max-width:520px" onclick="event.stopPropagation()">',
                ...
                '<div class="form-group">',
                    ...
                    '<input type="number" id="bm_amount" class="form-control" value="0" min="0" max="' + MAX_USER_BALANCE + '" step="1">',
                '</div>',
                '<div class="form-group">',
                    '<label>Причина</label>',
                    '<input type="text" id="bm_reason" class="form-control" maxlength="20" placeholder="Например: премия">',
                '</div>',
                '<div class="action-row mt-4">',
        ...
        '<div class="modal-overlay" id="bm_overlay">',
            '<div class="modal-content" style="max-width:520px" onclick="event.stopPropagation()">',
                ...
                '<div class="form-group">',
                    ...
                    '<select class="form-control" id="role_' + uid + '">',
                        optionsHtml,
                    '</select>',
                '</div>',
                '<div class="action-row mt-4">',
